...
public class RxImageConverters {
   ...
   private static MutableLiveData<File> mutableLiveData = new MutableLiveData<>();
    ...
    public static LiveData<File> uriToFile(final Fragment context, final Uri uri, final File file) {
        ...
        service.submit(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    InputStream inputStream = context.getActivity().getContentResolver().openInputStream(uri);
