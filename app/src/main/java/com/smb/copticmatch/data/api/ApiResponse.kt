...
import com.smb.copticmatch.BuildConfig
import com.smb.copticmatch.utils.logger.Log
    ...
    companion object {
        fun <T> create(throwable: Throwable): ApiErrorResponse<T> {
            ...
            val message: String = if (BuildConfig.DEBUG) {
                ...
                if (throwable is SocketTimeoutException) {
                    "Server not responding. Try again in a few"
                } else if (throwable is ConnectException) {
                    "Sorry, we couldn't connect to internet"
                } else {
        ...
        fun <T> create(response: Response<T>): ApiResponse<T> {
            return if (response.isSuccessful) {
                ...
                ApiErrorResponse(errorMsg ?: "Server not responding. Try again in a few")
            }
        }
    }
}
